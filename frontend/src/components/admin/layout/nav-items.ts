export interface NavItem {
  label: string;
  href: string;
  icon: string;        // SVG path data (multiple paths separated by space+M)
  permission?: string;
  badge?: string;
    ...
    items: [
      {
        ...
        description: 'Manage faculty, staff, officers and chairman',
      },
      {
        label: 'Alumni',
        href: '/admin/alumni',
        icon: 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z',
        description: 'Manage alumni directory and profiles',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Post official department notices',
      },
      {
        label: 'News Articles',
        href: '/admin/news',
      ...
      },
      {
        ...
        description: 'Showcase dept achievements',
      },
      {
        label: 'Clubs',
        href: '/admin/clubs',
      ...
      },
      {
        ...
        description: 'Photo albums and gallery',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: 'Programs, courses, resources, labs',
      },
    ],
  },
  {
