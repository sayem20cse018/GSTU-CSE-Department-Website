...
const TABS = [
  {
    ...
    content: `The Department of Computer Science and Engineering at ${SITE.university} was established in ${SITE.founded} with a vision to provide quality technical education in a rapidly evolving field. Since inception, the department has grown into a vibrant academic community with dedicated faculty, modern laboratories, and a commitment to research and innovation.

We offer comprehensive programs at the BSc, MSc, and PhD levels, designed to equip students with the theoretical foundation and practical skills necessary for success in both industry and academia. Our curriculum is continuously updated to reflect the latest developments in computing and technology.`,
  },
  {
    id: 'vision',
    label: 'Vision',
    ...
    content: `To be a leading center of excellence in Computer Science and Engineering education and research in Bangladesh, recognized for producing graduates who make significant contributions to technology, society, and the global knowledge economy.
...
We aspire to foster an inclusive, innovative, and intellectually vibrant environment where students, faculty, and researchers collaborate to solve real-world problems and advance the frontiers of computing.`,
  },
  {
    ...
    content: `Our mission is to provide rigorous, high-quality education in computer science and engineering that prepares students for lifelong learning and professional success. We are committed to:
...
// ─── Tab component (client would be better, but for SSR we use checkbox hack-free approach via server) ─────
// Using a simple client boundary just for the tab interaction
