...
const DEFAULT_AREAS = [
  { _id:'1', name:'Machine Learning & Artificial Intelligence', description:'Deep learning, neural networks, NLP, computer vision.', icon:'🤖', isActive:true, sortOrder:1 },
  { _id:'2', name:'Cybersecurity & Network Security', description:'Intrusion detection, cryptography, network protocols.', icon:'🔐', isActive:true, sortOrder:2 },
  { _id:'3', name:'Internet of Things (IoT)', description:'Embedded systems, sensor networks, smart devices.', icon:'📡', isActive:true, sortOrder:3 },
  { _id:'4', name:'Software Engineering', description:'Agile methods, software quality, testing.', icon:'⚙️', isActive:true, sortOrder:4 },
  { _id:'5', name:'Data Science & Big Data', description:'Data mining, analytics, visualization.', icon:'📊', isActive:true, sortOrder:5 },
  { _id:'6', name:'Computer Networks', description:'SDN, wireless, QoS, protocol design.', icon:'🌐', isActive:true, sortOrder:6 },
];
...
export default function ResearchAreasPage() {
  ...
  async function save() {
    ...
    try {
      if (editing) await adminPatch(`/research/areas/${editing._id}`, form);
            ...
            <div key={a._id} className={cn(
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition">
                  ...
                  <button onClick={() => del(a._id)} disabled={delId === a._id}
