    ...
    <>
      ...
      <main className="bg-white section-py">
        <div className="container-custom">
          ...
          {/* Featured lab */}
          {featured.map(lab => (
            <article key={lab._id} className="mb-10 bg-[#0d1b2e] text-white rounded-2xl overflow-hidden border border-white/10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...remaining, ...(featured.length?[]:[])].map(lab => (
              <article key={lab._id} className="border border-slate-200 rounded-2xl overflow-hidden hover:border-blue-300 hover:shadow-md transition group">
